...
numeropayasos = int(input("Ingrese nº payasos vendidos: "))
numeromunecas = int(input("Ingrese nº munecas vendidas: "))
print("El peso total del envío es de: ", ((numeropayasos * 112)+(numeromunecas * 75)), "gramos")