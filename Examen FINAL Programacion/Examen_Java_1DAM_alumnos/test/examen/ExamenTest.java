...
public class ExamenTest {
    ...
    public void testAgregarContacto() {
        ...
        Agenda.Contacto c = new Agenda.Contacto("Pepe", "123", "pepe@gmail.com");
    ...
    public void testEliminarContacto() {
        Agenda agenda = new Agenda();
        agenda.agregarContacto(new Agenda.Contacto("Ana", "111", "ana@correo.com"));
    ...
    public void testBuscarContacto() {
        Agenda agenda = new Agenda();
        agenda.agregarContacto(new Agenda.Contacto("Carlos", "222", "carlos@mail.com"));
        agenda.agregarContacto(new Agenda.Contacto("Carla", "333", "carla@mail.com"));

        List<Agenda.Contacto> resultados = agenda.buscarContacto("car");
    ...
    public void testCopiaImagen() {
        String origen = "resources/imagen_original.jpg";
        String destino = "resources/imagen_copia.jpg";
    ...
    public void testSerializacionYDeserializacion() {
        ...
        List<Agenda.Persona> personasOriginal = new ArrayList<>();
        personasOriginal.add(new Agenda.Persona("Juan", 28));
        personasOriginal.add(new Agenda.Persona("Lucía", 34));
        ...
        List<Agenda.Persona> personasCargadas = SerializadorObjetos.cargarPersonas(ruta);
